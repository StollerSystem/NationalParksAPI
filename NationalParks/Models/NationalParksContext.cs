  ...
  public class NationalParksContext : DbContext
  {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
      ...
      builder.Entity<StatePark>()
        .HasData(
          new StatePark { StateParkId = 1, StateParkName = "Goose Lake", StateParkDescription = "test", State = "Oregon", YearRound = false },
          new StatePark { StateParkId = 2, StateParkName = "Smith Rock", StateParkDescription = "test", State = "Oregon", YearRound = false },
          new StatePark { StateParkId = 3, StateParkName = "The Cove Palisades", StateParkDescription = "test", State = "Oregon", YearRound = true },
          new StatePark { StateParkId = 4, StateParkName = "Cape Lookout", StateParkDescription = "test", State = "Oregon", YearRound = true },
          new StatePark { StateParkId = 5, StateParkName = "Oswald West", StateParkDescription = "test", State = "Oregon", YearRound = true }
